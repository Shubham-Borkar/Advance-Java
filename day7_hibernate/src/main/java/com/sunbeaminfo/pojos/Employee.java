...
@Table(name="emps") //to customize table name
public class Employee {
//as per hibernate specs : declare ID property : Serializable
	 //int : also  works --> autoboxing 
	//better alternative : Integer / Long (null checking is easier)
	@Id //PK constraint : mandatory : not auto generated by hib.
	//for auto generation of ids (PK) 
	//hibernate will supply , auto incremented ids., best suited mysql DB
		@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name="emp_id")//customizes col name
	 private Long empId;
